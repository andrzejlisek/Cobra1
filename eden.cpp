...
///
/// \brief Eden::LTrim - Removes leading whitespaces from string
/// \param X
/// \return
///
string Eden::LTrim(string X)
{
    string S = X;
...
///
/// \brief Eden::RTrim - Removes trailing whitespaces from string
/// \param X
/// \return
///
string Eden::RTrim(string X)
{
    string S = X;
